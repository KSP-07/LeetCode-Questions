...
class Solution
{
        ...
        Node *copyList(Node *head)
    {
        //Write your code here
         unordered_map<Node*,Node*>mp;  // create a map
...
space optimized approach -
    ...
    Node *copyList(Node *head)
    {
        ...
        //inserting copied nodes in between
        while(curr){
        ...
        //setting up arb pointers in updated list
        curr = head;
        while(curr){
            if(curr->arb){
                curr->next->arb = curr->arb->next;
            }
            else curr->next->arb = NULL;
            
            curr = curr->next->next;
        }
        
        //ab reseting the list to separate copied and orginal
